...
class SumaEmpleadosController {
    ...
    public async list (req: Request, res: Response) {
        ...
        const asistencia = await pool.query('SELECT COUNT(empleado.id) as cantidadempleados from empleado', function(err,result, fields){
            if (err) throw err;
            res.json(result);
        });
...
export const sumaEmpleadosController = new SumaEmpleadosController();
export default sumaEmpleadosController;