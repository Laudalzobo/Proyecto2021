...
class SumaTotalController {
    ...
    public async list (req: Request, res: Response) {
        ...
        const asistencia = await pool.query('SELECT SUM(a.presente) as suma FROM ASISTENCIA as a inner join empleado as e on e.id = a.idEmpleado',[idObra,fecha], function(err,result, fields){
            if (err) throw err;
            res.json(result);
        });
...
export const sumaTotalController = new SumaTotalController();
export default sumaTotalController;