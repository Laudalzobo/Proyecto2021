...
class ContadorObrasController {
    ...
    public async list (req: Request, res: Response) {
        ...
        const asistencia = await pool.query('SELECT COUNT(obra.id) as cantidadobras from obra', function(err,result, fields){
            if (err) throw err;
            res.json(result);
        });
...
export const contadorObrasController = new ContadorObrasController();
export default contadorObrasController;