...
exports.sumaMaterialesController = void 0;
const database_1 = __importDefault(require("../database"));
class SumaMaterialesController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const asistencia = yield database_1.default.query('SELECT SUM(movimiento.cantidad) as cantidadmateriales from movimiento', function (err, result, fields) {
                if (err)
                    throw err;
                res.json(result);
            });
...
exports.sumaMaterialesController = new SumaMaterialesController();
exports.default = exports.sumaMaterialesController;
