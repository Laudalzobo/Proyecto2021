...
exports.contadorAsistenciaController = void 0;
const database_1 = __importDefault(require("../database"));
class ContadorAsistenciaController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const asistencia = yield database_1.default.query('    SELECT a.idEmpleado,e.apellido,e.nombre, SUM(a.presente) as suma FROM ASISTENCIA as a inner join empleado as e on e.id = a.idEmpleado GROUP BY a.idEmpleado', function (err, result, fields) {
                if (err)
                    throw err;
                res.json(result);
            });
...
exports.contadorAsistenciaController = new ContadorAsistenciaController();
exports.default = exports.contadorAsistenciaController;
