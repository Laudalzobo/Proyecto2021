...
exports.sumaEmpleadosController = void 0;
const database_1 = __importDefault(require("../database"));
class SumaEmpleadosController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const asistencia = yield database_1.default.query('SELECT COUNT(empleado.id) as cantidadempleados from empleado', function (err, result, fields) {
                if (err)
                    throw err;
                res.json(result);
            });
...
exports.sumaEmpleadosController = new SumaEmpleadosController();
exports.default = exports.sumaEmpleadosController;
