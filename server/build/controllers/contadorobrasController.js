...
exports.contadorObrasController = void 0;
const database_1 = __importDefault(require("../database"));
class ContadorObrasController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const asistencia = yield database_1.default.query('SELECT COUNT(obra.id) as cantidadobras from obra', function (err, result, fields) {
                if (err)
                    throw err;
                res.json(result);
            });
...
exports.contadorObrasController = new ContadorObrasController();
exports.default = exports.contadorObrasController;
