...
exports.sumaTotalController = void 0;
const database_1 = __importDefault(require("../database"));
class SumaTotalController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { idObra } = req.params;
            const { fecha } = req.params;
            const asistencia = yield database_1.default.query('SELECT SUM(a.presente) as suma FROM ASISTENCIA as a inner join empleado as e on e.id = a.idEmpleado', [idObra, fecha], function (err, result, fields) {
                if (err)
                    throw err;
                res.json(result);
            });
...
exports.sumaTotalController = new SumaTotalController();
exports.default = exports.sumaTotalController;
